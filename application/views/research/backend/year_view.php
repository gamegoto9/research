...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			$('#showDataTable').load("<?php echo base_url('main/modi_year')?>");	
	} );
	...
	function showModel(view){
		...
		load_view = view;
		$('#model_view').load("<?php echo base_url('main/year_form/');?>/"+load_view);
		$('#myModel').modal('show');
	...
	function showModel_edit(xid){
		...
		$('#model_view').load('<?php echo site_url('main/year_form_edit'); ?>',sdata);
		$('#myModel').modal('show');
	}
	...
	function showModel_delete(xid){
		...
		bootbox.confirm("Are you sure?", function(result) {
			if(result){
				...
				var faction = "<?php echo site_url('/main/action_year/'); ?>/"+load_view;
				var fdata = {id:xid};
