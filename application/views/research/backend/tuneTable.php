	...
	<table id="mMenuTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
		...
		<tbody>
			...
			foreach ($mainMenu as $mMenu){
				...
				<tr>
					<td><?php echo $i; ?></td>
					<td><?php echo $mMenu['tName']; ?></td>
					<!-- <td><a class="btn btn-primary"><i class="fa fa-exclamation-circle"></i></a></td> -->
					<td><a class="btn btn-warning" onclick="showModel_edit(<?php echo $mMenu['tId']; ?>);" ><i class="fa fa-edit"></i></a></td>
					<td><a class="btn btn-danger" onclick="showModel_delete(<?php echo $mMenu['tId']; ?>);"><i class="fa fa-trash-o"></i></a></td>
				</tr>
				<?php } ?>
			</tbody>
		</table>
