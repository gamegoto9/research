...
<html lang="en">
  <head>
    ...
    <title>ระบบงานโครงการวิจัย</title>
...
<div id="cl-wrapper" class="login-container">
    <div class="middle-login">
        <div class="block-flat">
            <div class="header">
                <h3 class="text-center"><img src="<?php echo base_url('assets/img/logo.png')?>" alt="logo" class="logo-img">ระบบโครงการงานวิจัย</h3>
            </div>
            <div>
...
<!--                        <button data-dismiss="modal" type="button" class="btn btn-default">Register</button>-->
                        <button  type="submit" class="btn btn-primary" id="btn_save">เข้าสู่ระบบ</button>
                    </div>
                </form>
            </div>
        </div>
