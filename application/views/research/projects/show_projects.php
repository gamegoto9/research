  ...
  <div class="row">
    <div class="col-sm-12 col-md-12">
      <div class="block-flat">
        <div class="header">
          <h4>ค้นหาจากชื่อโครงการงานวิจัย</h4>
        </div>
        <br>
        <div id="content">
        ...
        <form class="form-horizontal">
          ...
          <div class="form-group" >
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-warning" onclick="add_projects1();">เพิ่มข้อมูล</button>
            </div>
          </div>
  ...
  <div class="modal-dialog  modal-lg modal-admin" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #0f76dc;">
        ...
        <h4 class="modal-title"><font color="#fff">โครงการงานวิจัย</font></h4>
      </div>
...
<script type="text/javascript">
  ...
  function btnSeR(){
                ...
                var page = '<?php echo site_url('main/search_projects/'); ?>';
                //alert(page);
  ...
  function eidt_researchs(researchId){
    var id = researchId;
    $('#model_viewMain').load("<?php echo base_url('main/edit_projects/')?>/"+id);
  ...
  function delete_researchs(research_id){
    bootbox.confirm("ยืนยันการลบ?", function(result) {
      if(result){
        ...
        var faction = "<?php echo site_url('main/delete_projects/'); ?>";
