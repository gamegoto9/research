...
<script src="<?PHP echo base_url('assets/lib/bootstrap.switch/js/bootstrap-switch.js'); ?>" type="text/javascript"></script>
<script src="<?PHP echo base_url('assets/lib/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js'); ?>" type="text/javascript"></script>
<script src="<?PHP echo base_url('assets/lib/jquery.icheck/icheck.min.js'); ?>" type="text/javascript"></script>
<script src="<?PHP echo base_url('assets/lib/moment.js/min/moment.min.js'); ?>" type="text/javascript"></script>
<script src="<?PHP echo base_url('assets/lib/bootstrap.daterangepicker/daterangepicker.js'); ?>" type="text/javascript"></script>
<script src="<?PHP echo base_url('assets/lib/bootstrap.slider/js/bootstrap-slider.js'); ?>" type="text/javascript"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/lib/bootpag/jquery.bootpag.min.js');?>"></script>
